...
class CDevAssistIFModule :
	public ATL::CAtlMfcModule
{
public:
	DECLARE_LIBID(LIBID_DevAssistIFLib);
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_DEVASSISTIF, "{7D0FACB0-8E9E-48FA-9CEA-583986D99FB8}");};

CDevAssistIFModule _AtlModule;
